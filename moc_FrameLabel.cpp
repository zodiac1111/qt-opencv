...
void FrameLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newMouseData((*reinterpret_cast< MouseData(*)>(_a[1]))); break;
        case 1: _t->onMouseMoveEvent(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData FrameLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrameLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_FrameLabel,
      qt_meta_data_FrameLabel, &staticMetaObjectExtraData }
};
